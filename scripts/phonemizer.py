...
They may be some divergence between the phonemic representention
which is an abstract representation and the phonetic realization
which is in contrast concrete and can be influenced by the stress,\
phonotactic, idiophonic features, etc.
"""
